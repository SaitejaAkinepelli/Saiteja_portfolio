  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      details: 'saitejaakinapelly@gmail.com',
      link: 'mailto:saitejaakinapelly@gmail.com'
    },
    {
      icon: <Phone className="h-6 w-6 text-primary" />,
      title: 'Phone',
      details: '+91 7569247365',
      link: 'tel:+917569247365'
    },
    {
    ...
    <section className="py-20">
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
              <div className="p-8 rounded-xl border border-primary/20 transition-all duration-300 hover:shadow-lg">
          ...
          <div className="space-y-6">
            ...
            <motion.div 
              className="p-8 rounded-xl border border-primary/20 transition-all duration-300 hover:shadow-lg mt-8"
            ...
            >
              ...
              <div className="flex space-x-4">
                <Button variant="outline" size="icon" className="rounded-full" asChild>
                  <a href="https://www.linkedin.com/in/akinepelli-saiteja-4042322a0" target="_blank" rel="noopener noreferrer">
                ...
                <Button variant="outline" size="icon" className="rounded-full" asChild>
                  <a href="https://github.com/Saiteja1807200" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                ...
                <Button variant="outline" size="icon" className="rounded-full" asChild>
                  <a href="https://x.com/iamSaiteja_?t=piTSKsEjibxAqbDg7pvSAg&s=09" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                ...
                <Button variant="outline" size="icon" className="rounded-full" asChild>
                  <a href="https://www.instagram.com/saitejaaa_1807?igsh=MTNpbDFwZzZ6a3VkZw==" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
